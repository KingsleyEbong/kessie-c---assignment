                             ...
                             int currentMonth, int thisYear)
{
    ...
    void setAge(int today, int currentMonth, int thisYear);    // call set function to calculate age
}
...
int getMaximumHeartRate(maximumheartrate)
{
	return 220 - Age;
}

double maxiTargetRate(target heartrate)
{
	return MaximumHeartRate*50/100;
}

double getTargetHeartRate(target heart rate)
{
